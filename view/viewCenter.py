scale_l=[0.15,0.3,0.1,0.03] #每个视角抽取特征的比例
...
def calculate_distance(view_id, sample_index, experiment_amount):
...
#计算样本距离视角view_id的中心点距离
def t_calculate_distance(view_id, sample_index, experiment_amount):
    global feature_index_l
    global class1_center_l, class2_center_l, class12_distance_l
    global feature_offset_l
    global x_train 
...
def init_center(view_amount,f_amount_l,f_offset_l, experiment_amount):
    global feature_index_l
    global class1_center_l, class2_center_l, class12_distance_l
    global feature_offset_l
